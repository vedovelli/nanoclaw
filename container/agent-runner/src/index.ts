...
const SECRET_ENV_VARS = ['ANTHROPIC_API_KEY', 'ANTHROPIC_API_URL', 'ANTHROPIC_BASE_URL', 'ANTHROPIC_AUTH_TOKEN', 'CLAUDE_CODE_OAUTH_TOKEN'];
      ...
      mcpServers: {
        ...
        calendar: {
          ...
          env: {
            ...
            GOOGLE_CALENDAR_MCP_TOKEN_PATH: '/home/node/.calendar-mcp/token.json',
          },
        },
        flare: {
          command: 'npx',
